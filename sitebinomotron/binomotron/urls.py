...
urlpatterns = [
    ...
    path('apprenant/supprimer/<int:pk>/', views.ApprenantDeleteView.as_view(), name="supprimer-apprenant"),
    ...
    path('brief/supprimer/<int:pk>/', views.BriefDeleteView.as_view(), name="supprimer-brief"),
